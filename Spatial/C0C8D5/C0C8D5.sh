...
cp /hpctmp/dbstq/HLG/C0C8D5/Mantel.R Mantel.R
source activate R
for j in *.vcf
do base=${j%.vcf*}
...
cp mantelrr.csv /hpctmp/dbstq/HLG/C0C8D5/run"$i"_mantelrr.csv
cp fisf.csv /hpctmp/dbstq/HLG/C0C8D5/run"$i"_fisf.csv
cp pis.csv /hpctmp/dbstq/HLG/C0C8D5/run"$i"_.pis.csv
cd ../../
rm -rf it--1
done
